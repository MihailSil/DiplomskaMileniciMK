...
--
-- Dumping events for database 'milenici'
--

--
-- Dumping routines for database 'milenici'
--
/*!50003 DROP PROCEDURE IF EXISTS `AdminDeletePost` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AdminDeletePost`(
    IN p_post_id INT
)
BEGIN
...
BEGIN
    INSERT INTO posts (user_id, name, phone, email, pet_type, picture, description)
    VALUES (p_user_id, p_name, p_phone, p_email, p_pet_type, p_picture, p_description);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    INSERT INTO reports (report_text)
    VALUES (p_report_text);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    UPDATE posts
    SET name = p_name, phone = p_phone, email = p_email, pet_type = p_pet_type, description = p_description, picture = p_picture
    WHERE id = p_post_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2024-09-15 21:02:32
